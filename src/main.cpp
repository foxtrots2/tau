...
int main() {
	...
	float* skyboxData = stbi_loadf("skyboxes\\sky_default.hdr", &sbWidth, &sbHeight, &sbChannels, 0);
	...
	GLFWwindow* programWindow = glfwCreateWindow(screenWidth, screenHeight, "Tau Engine 0.0.1a", NULL, NULL);
